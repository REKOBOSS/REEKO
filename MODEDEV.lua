...
sudo_users = {SUDO,1362789822,bot_id}
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'ch_reko')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'ch_reko')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ch_reko')..') \n •'..MODEDEV1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/ch_reko)}\n•["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/ch_reko)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@ch_reko','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس', url="t.me/ch_reko"},
},
{
...
{
{text = 'مطور السـورس', url="t.me/boss_lol0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ch_reko')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'ch_reko')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ch_reko')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'ch_reko')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1362789822) then
...
if result.id_ == tonumber(1362789822) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'ch_reko')..')'
...
local UserName = (b.username_ or "ch_reko")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'ch_reko')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/ch_reko) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [Ꮢēĸσ - SoUrCe](https://t.me/ch_reko)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/ch_reko)}\n•["..MODEDEVAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
